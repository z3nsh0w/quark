...
class AndroidPlaylistOverlay extends StatefulWidget {
  ...
  @override
  State<AndroidPlaylistOverlay> createState() => _AndroidPlaylistOverlayState();
}

class _AndroidPlaylistOverlayState extends State<AndroidPlaylistOverlay> {
  bool needSync = false;
  ...
  @override
  void didUpdateWidget(covariant AndroidPlaylistOverlay oldWidget) {
                        ...
                        children: [
                          Padding(
                            ...
                            child: playlistSearch(_searchController, search),
                               ...
                               // IconButton(onPressed: widget.togglePlaylist, icon: Icon(Icons.keyboard_arrow_down_rounded)),
                          Expanded(
