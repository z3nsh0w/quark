...
class _MainPlayerState extends State<MainPlayer> with TickerProviderStateMixin {
  ...
  void subscribeDatabase() {
    DatabaseStreamerService().transitionSpeed.addListener(updateFromDatabase);
    DatabaseStreamerService().stateIndicator.addListener(updateFromDatabase);
    DatabaseStreamerService().playlistOpeningArea.addListener(
      updateFromDatabase,
    );
  }

  void unSubscribeDatabase() {
    DatabaseStreamerService().transitionSpeed.removeListener(
      updateFromDatabase,
    );
    DatabaseStreamerService().stateIndicator.removeListener(updateFromDatabase);
    DatabaseStreamerService().playlistOpeningArea.removeListener(
      updateFromDatabase,
    );
  }
  ...
  void initState() {
    ...
    DynamicWindowColor.notifySize(WindowSize.standart);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Listener(
                            ...
                            child: VolumeWidget(interactiveWidth: 330),
                          ),
              ...
              Positioned(
                ...
                child: SlideTransition(
                  ...
                  child: LyricsView(
                    ...
                    key: ValueKey((nowPlayingTrack as YandexMusicTrack).track),
                  ),
                ),
              ),
