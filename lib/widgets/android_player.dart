...
import './playlist_widget_android.dart';
...
class _PlaylistPage1State extends State<AndroidWidget>
  ...
  Widget get _expandedHeader =>
      animatedExpandButton(() => expandController.collapse(), Icons.radio_button_checked);
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Container(
                                        // UI KOSTIL'
                                        padding: EdgeInsetsGeometry.only(bottom: 10, left: 170),
                                        // 
                                        child: // ALBUM TEXT
                                        Text(
                                  ...
                                  if (nowPlayingTrack is YandexMusicTrack)
                                    Padding(padding:  EdgeInsetsGeometry.only(top: 30, right: 30),
